  ...
  <a-card title="欢迎注册" class="card">
    <a-form
      ...
      <a-form-item :wrapper-col="{ ...layout.wrapperCol, offset: 8 }" style="margin-top: 2rem;">
        <a-button type="primary" ghost html-type="submit" @click="login" class="login-form-button">注册</a-button>
      </a-form-item>
      <a class="login-form-forgot" href="#">已有账号去登录?</a>
    </a-form>
  </a-card>
</template>
